...
if __name__=="__main__":
    for n in [8, 20, 28, 50, 82, 126]: 
        ...
        data = r, HO_rho(r)
        problem = Problem(Z=n,n_type='p', max_iter=4000, ub=10.1, debug='y', \
        ...
        data = np.column_stack((solver.grid, pot))
        np.savetxt("Potentials/pot_HO_"+str(n)+"_particles_coupled_basis_pyt.dat", data)
