...
from Energy_mod import Energy

def plotEnergy(E1, r1, E2, r2, scaling, rho_type, output="NEW_Case1", save='y'):
        ...
        if(save == 'y'):
            ...
            file = "/NEW_test_case1_" + scaling + "_rho=" + rho_type + ".png"
...
if __name__ == "__main__":
    ...
    aa = 0.5
    RR = 10.
    ref_rho = lambda r : a * (1+np.exp((r-RR)/aa))**-1
    
    #defining potential
    def potential(r, rho, N=1, ref_rho=None, N_ref=1, t=1):
        if ref_rho == None : ref_rho = lambda r: np.zeros_like(r)
        v = 2*a * (ref_rho(r)/N_ref + t * (rho(r)/N - ref_rho(r)/N_ref))
